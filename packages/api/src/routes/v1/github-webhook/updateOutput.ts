...
import type { GhostName } from '$shared/ghost/types/GhostName.js'
import type { GhostStatusShortHand } from '$shared/ghost/types/GhostStatusShortHand.js'
import type { ChecksOutput } from 'octoflare'
